        ...
        <div className="w-full md:w-1/2 p-12 md:p-20 flex flex-col justify-center">
          ...
          <div className="grid grid-cols-3 gap-6 py-8 border-y border-white/5 mb-10">
             ...
             <div className="text-center">
                ...
                <span className="text-[9px] uppercase text-[#8ECAE6] tracking-widest">Banos</span>
             </div>
             <div className="text-center">
                <span className="block text-2xl font-serif text-white">{property.sqft}</span>
                <span className="text-[9px] uppercase text-[#8ECAE6] tracking-widest">M2</span>
             </div>
          </div>
...
const MainExperience: React.FC<{ onSelect: (p: Property) => void }> = ({ onSelect }) => {
  ...
  const heroY = useTransform(smoothProgress, [0, 0.08], [0, -80]);
  const contentReveal = useTransform(smoothProgress, [0.1, 0.2], [0, 1]);
      ...
      <div ref={containerRef} className="relative min-h-[500vh]">
        ...
        <section className="sticky top-0 h-screen w-full flex flex-col items-center justify-center z-20 px-6">
          ...
          >
            ...
            >
              "Donde el desarrollo encuentra su maxima plenitud."
            </motion.h1>
            ...
            <div className="max-w-7xl mx-auto mb-64 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="space-y-8 text-white/70 text-lg md:text-2xl font-light leading-relaxed">
                  <p>
                    <strong className="text-white font-serif italic text-3xl block mb-4">Brisa del Mar</strong>
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                className="relative aspect-[4/5] rounded-[60px] overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.6)] order-1 md:order-2"
              >
                <img src={xeelenjaMeaningImg} className="w-full h-full object-cover" alt="Brisa del Mar" />
      ...
      <div className="relative min-h-screen bg-[#001529] selection-blue">
        ...
        <main>
          <Routes>
            ...
            <Route 
              path="/financiamiento" 
              element={<GenericPage title="Estrategia" subtitle="Modelos de inversion con respaldo institucional" icon={<CreditCard />} />} 
            />
          </Routes>
        </main>
        ...
        <footer className="bg-[#000c18] py-32 px-10 border-t border-white/5 relative z-50">
          <div className="container mx-auto flex flex-col items-center gap-16">
            ...
            <div className="text-white/10 text-[8px] uppercase tracking-[0.4em] text-center max-w-2xl font-light leading-relaxed">
              (c) 2025 XEELENJA PROPERTIES & FULLNESSLAND. ARQUITECTURA DEL FUTURO. CANCUN, MEXICO.
            </div>
          </div>
        </footer>
